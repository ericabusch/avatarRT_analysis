...
if __name__ == '__main__':
    ...
    for label, grp, vals, p in [('IM', 'IM vs 0',   v_im, p_im_0),
                                  ('WMP','WMP vs 0',  v_wm, p_wmp_0),
                                  ('OMP','OMP vs 0',  v_om, p_omp_0)]:
        all_stats.append({
            ...
            'p_value': p, 'ci_lower': eval(f'lower_{label.lower()}_0'), 'ci_upper': eval(f'upper_{label.lower()}_0'),
        })
    for label, g1, g2, vals1, vals2, p in [
        ('IM vs WMP', 'IM', 'WMP', v_im, v_wm, p_im_wm),
        ('IM vs OMP', 'IM', 'OMP', v_im, v_om, p_im_om),
        ('WMP vs OMP','WMP','OMP', v_wm, v_om, p_wm_om),
    ]:
        all_stats.append({
